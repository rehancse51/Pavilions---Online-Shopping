...
<div class="row-fluid sortable">		
    <div class="box span12">
        ...
        <div class="box-content">
            <h1 style="color: green;">Ordered Customer Information</h1>
            ...
            <h1 style="color: green;">Ordered Shipping Information</h1>
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                <tr>
                    <th>Customer Name</th>
            ...
            <h1 style="color: green;">Ordered Product Information</h1>
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                <tr>
...
<?php } ?>
            ...
            <h1 style="color: green;">Ordered Payment Information</h1>
            <table class="table table-striped table-bordered bootstrap-datatable datatable">
                <tr>
                    <th>Payment Type</th>
    ...
    <button onclick="myFunction()" class="btn btn-primary btn-lg">Print</button>
